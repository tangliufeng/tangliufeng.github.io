...
![](/img/in-post/post-ble/post-eleme-pwa/PUSH-link-rel-preload.jpg)
...
![](/img/in-post/post-ble/post-eleme-pwa/PRECACHE-future-routes.jpg)
...
![](/img/in-post/post-ble/post-eleme-pwa/Lighthouse-before.png)
...
![](/img/in-post/post-ble/post-eleme-pwa/before-skeleton.jpg)
*从首页点击到发现页，跳转过程中的白屏*
...
![](/img/in-post/post-ble/post-eleme-pwa/msite-Before-Optim.png)
...
![](/img/in-post/post-ble/post-eleme-pwa/after-skeleton.jpg)
*在添加骨架屏后，从发现页点回首页的效果*
...
![](/img/in-post/post-ble/post-eleme-pwa/thisTick-&-Load.png)
...
![](/img/in-post/post-ble/post-eleme-pwa/nextTick-&-Load.png)
...
![](/img/in-post/post-ble/post-eleme-pwa/msite-After-Optim.png)
...
![](/img/in-post/post-ble/post-eleme-pwa/Lighthouse-after.png)

最后附上一张图，这张图当时是做给 Addy Osmani 的 I/O 演讲用的，描述了饿了么 PWA 是如何结合 Vue 来实现多页应用的 PRPL 模式，可以作为一个架构的参考与示意图。

![](/img/in-post/post-ble/post-eleme-pwa/Architecture.png)
